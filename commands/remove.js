...
module.exports.run = async (client, message, args) => {
    ...
    const categoryID = "959944225682763827";

    if(!message.member.roles.cache.has('1021393319210799114')) /*remove yetkili rol */ return message.reply("ticket'e üye çıkartmak için yetkin yok.");
